...
runtime scaling with the number of samples, particularly for the \emph{Full} bin likelihood we investigate
 primarily in this work, indicates that the parallel throughput of the GPU is being saturated. This 
 bottleneck can be mitigated by either; using a compressed likelihood (\emph{Heterodyning} being an 
 example of this shown in the figure), expanding processing over multiple GPUs, or, if possible, 
