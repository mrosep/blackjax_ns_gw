...
points and a termination condition of dlogZ < 0.1, the default in \texttt{bilby},
as well as the settings \texttt{naccept} = 60 and \texttt{maxmcmc} = 5000. 
The \texttt{blackjax ns} sampler was configured with \texttt{num\_delete} = 500, describing the batch size.
